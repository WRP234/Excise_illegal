...
export class MasPersonService extends ArrestHelperService {
  ...
  getcomments(): Observable<any> {
    let param2 = new HttpParams().set("postId", "1");
  ...
  MasPersongetByCon(form: MasPersonGetByCon): Observable<MasPerson[]> {
    const res = this.http.post(
      `${this.MasterApiPrefixUrl}/MasPersongetByCon`,
      form
    );
  ...
  MasPersoninsAll(form: MasPerson): Observable<any> {
    return this.httpService
      .post(`${this.MasterApiPrefixUrl}/MasPersoninsAll`, form)
      .pipe(map((x) => x.json()));
  }
  ...
  MasPersonAddressinsAll(form: MasPersonAddress[]): Observable<any> {
    return this.http.post(
      `${this.MasterApiPrefixUrl}/MasPersonAddressinsAll`,
      form
    );
  }
  ...
  MasPersonAddressupdAll(form: MasPersonAddress[]): Observable<any> {
    return this.http.post(
      `${this.MasterApiPrefixUrl}/MasPersonAddressupdAll`,
      form
    );
  }

  MasPersonAddressupdDelete(
    form: MasPersonAddressupdDelete[]
  ): Observable<any> {
    return this.http.post(
      `${this.MasterApiPrefixUrl}/MasPersonAddressupdDelete`,
      form
    );
  }
  ...
  MasPersonEducationinsAll(form: MasPersonEducation[]): Observable<any> {
    return this.http.post(
      `${this.MasterApiPrefixUrl}/MasPersonEducationinsAll`,
      form
    );
  }
  ...
  MasPersonEducationupdAll(form: MasPersonEducation[]): Observable<any> {
    return this.http.post(
      `${this.MasterApiPrefixUrl}/MasPersonEducationupdAll`,
      form
    );
  }

  MasPersonEducationupdDelete(
    form: MasPersonEducationupdDelete[]
  ): Observable<any> {
    return this.http.post(
      `${this.MasterApiPrefixUrl}/MasPersonEducationupdDelete`,
      form
    );
  }
  ...
  MasPersonRelationshipinsAll(form: MasPersonRelationship[]): Observable<any> {
    return this.http.post(
      `${this.MasterApiPrefixUrl}/MasPersonRelationshipinsAll`,
      form
    );
  }
  ...
  MasPersonRelationshipupdAll(form: MasPersonRelationship[]): Observable<any> {
    return this.http.post(
      `${this.MasterApiPrefixUrl}/MasPersonRelationshipupdAll`,
      form
    );
  }

  MasPersonRelationshipupdDelete(
    form: MasPersonRelationshipupdDelete[]
  ): Observable<any> {
    return this.http.post(
      `${this.MasterApiPrefixUrl}/MasPersonRelationshipupdDelete`,
      form
    );
  }
  ...
  MasPersonPhotoinsAll(form: MasPersonPhoto[]): Observable<any> {
    return this.http.post(
      `${this.MasterApiPrefixUrl}/MasPersonPhotoinsAll`,
      form
    );
  }
  ...
  MasPersonPhotoupdAll(form: MasPersonPhoto[]): Observable<any> {
    return this.http.post(
      `${this.MasterApiPrefixUrl}/MasPersonPhotoupdAll`,
      form
    );
  }
  ...
  MasPersonPhotoupdDelete(form: MasPersonPhotoupdDelete[]): Observable<any> {
    return this.http.post(
      `${this.MasterApiPrefixUrl}/MasPersonPhotoupdDelete`,
      form
    );
  }
  ...
  MasPersonFingerPrintinsAll(form: MasPersonFingerPrint[]): Observable<any> {
    return this.http.post(
      `${this.MasterApiPrefixUrl}/MasPersonFingerPrintinsAll`,
      form
    );
  }
  ...
  MasPersonFingerPrintupdAll(form: MasPersonFingerPrint[]): Observable<any> {
    return this.http.post(
      `${this.MasterApiPrefixUrl}/MasPersonFingerPrintupdAll`,
      form
    );
  }

  MasPersonFingerPrintupdDelete(
    form: MasPersonFingerPrintupdDelete[]
  ): Observable<any> {
    return this.http.post(
      `${this.MasterApiPrefixUrl}/MasPersonFingerPrintupdDelete`,
      form
    );
  }
}
